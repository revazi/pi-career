...
const notes = [
  ...
  `npm shasum: \`${shasum}\``,
  "",
  "This native-free pi-career package supports `darwin-arm64`, `darwin-x64`, `linux-x64-gnu`, `linux-arm64-gnu`, `linux-x64-musl`, and `linux-arm64-musl` through exact external `@revazi/career@0.2.0` and validates its exact ordered six-package v2 manifest. Only the launcher is a pi-career installation surface, and Windows remains unsupported.",
  "",
