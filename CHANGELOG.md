...
- Standalone private Pi package with the stable `career_core_discover`, `career_core_resume`, and `career_core_job` tools.
...
- Native CI execution for every claimed target without a private Core checkout or provider credentials.
- Basic private-repository author, ownership, issue-form, Dependabot, and pull-request hygiene.
